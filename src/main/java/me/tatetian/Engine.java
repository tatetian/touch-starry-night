...
//		switchScene(NebulaScene.get(NebulaScene.Name.M51) );
	...
	public static class Guide implements Runnable, Interactive {
		...
		private PFont font;
		private String text = "《触摸星空》作品说明：点触油画上的星星来与之交互，多次点击同一颗星星会有更多效果";
		...
		public Guide(Engine e) {
			...
			font = engine.createFont("cn_font.ttf", 26);
		}
		...
		public void draw() {
			if(show_text) {
				engine.pushMatrix();
				engine.translate(engine.WIN_W /2, engine.WIN_H - 100, engine.WIN_D + 100);
				int greyStroke = engine.color(255, 255, 255, 120);
